	...
	)
{
	...
	uint32		*kaddr;		/* Kernel address		*/
	uint32		*uaddr;		/* User address		*/
	...
	prcount++;
	global_kaddr = (char *)kaddr;
	global_uaddr = (char *)uaddr;
	prptr = &proctab[pid];
	...
	prptr->prkstack = (char *)kaddr;
	prptr->prustack = global_uaddr;
